...
## Obtaining the file
  ...
  2. Navigate to `1:/data/<id0>/extdata/00048000/f000000b/00000000/`{: .filepath} and pres A on one of the files that are 319.2 kb.
  3. Mount as DIFF image and enter it.
